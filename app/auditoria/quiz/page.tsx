...
export default function AuditoriaQuizPage() {
  return (
    <div className="py-12 md:py-24 px-4 sm:px-6 lg:px-8 relative z-10 min-h-screen">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <Link
            href="/auditoria"
            className="text-blue-300 hover:text-blue-100 flex items-center transition-colors duration-300 mb-3 md:mb-4 text-sm md:text-base"
          >
            <svg
          ...
          <h1 className="text-xl sm:text-2xl md:text-4xl font-bold text-white mb-2">
            Quiz de Auditoria de Segurança
          </h1>
          ...
          <p className="text-blue-100 text-sm sm:text-base md:text-lg max-w-3xl">
            Teste seus conhecimentos em auditoria de segurança com nosso quiz
            interativo. Responda questões sobre avaliação de riscos, conformidade,
        ...
        >
          <QuizComponent segmento="auditoria" />
        </motion.div>
      </div>
    </div>
  );
